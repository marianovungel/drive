    ...
    <div className="App">
      <Router>
          <Routes> 
            ...
            <Route path="/gerenciar" element={user.login === "Drive@t" ? <Gerenciar /> : <Login /> } exact />
            <Route path="/homeadm" element={user.login === "Drive@t" ? <HomeAdm /> : <Login /> } exact />
            <Route path="/solicitacoes" element={user.login === "Drive@t" ? <SolicitarAdm /> : <Login /> } exact />
            <Route path="/form_preenchido/:id" element={user.login === "Drive@t" ? <SingleSol /> : <Login /> } exact />
          </Routes>
        </Router>
    </div>
  );
